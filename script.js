...
//onst gradienSubtractProgram = new Program(baseVertexShader, gradientSubtractShader);
...
function initSunraysFramebuffers () {
  ...
  //  sunraysTemp = createFBO(res.width, res.height, rgba.internalFormat, rgba.format, texType, filtering);
}
